...
import Seminar4.Shields.Manlet;
import Seminar4.Weapons.Melee;
import Seminar4.Weapons.Ranged;
...
*/
       ...
       /* for (BaseHero item : squadA) {
        ...
        squadS.add(new Archer(15, "jonathan", new Ranged("crossbow", 15,
                25),new Manlet("Aegis" , 30, false)));
        squadS.add(new Footman(55, "carl", new Melee("sword", 10),
                new HandShield("Pridwen" , 20, true)));
